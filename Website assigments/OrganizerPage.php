...
<p style="font-family: verdana; font-size:18px">Organizer Page</p>
...
<div>
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#1" aria-controls="1" role="tab" data-toggle="tab">Events</a></li>
...
?>
        <tr>
			...
			<td><a href="updatepage.php?id=<?php echo $row['id']; ?>"><span class="glyphicon glyphicon-open" aria-hidden="true"></span></a>
            /<a href="delete.php?id=<?php echo $row['id']; ?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a></td>
